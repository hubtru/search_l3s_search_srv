...
class SkillApi(object):
    ...
    def skill_mgmt_controller_adapt_repo(self, body, repository_id, **kwargs):  # noqa: E501
        ...
        :param SkillRepositoryUpdateDto body: (required)
    ...
    def skill_mgmt_controller_adapt_repo_with_http_info(self, body, repository_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/skill-repositories/{repositoryId}', 'PATCH',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def skill_mgmt_controller_update_skill(self, body, skill_id, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.skill_mgmt_controller_update_skill_with_http_info(body, skill_id, **kwargs)  # noqa: E501
        else:
            (data) = self.skill_mgmt_controller_update_skill_with_http_info(body, skill_id, **kwargs)  # noqa: E501
            return data

    def skill_mgmt_controller_update_skill_with_http_info(self, body, skill_id, **kwargs):  # noqa: E501
        """skill_mgmt_controller_update_skill  # noqa: E501

        Updates a skill as follows: - First: It will update all values of the skill (name, level, description, nestedSkills, parentSkills) - Second: It will move the skill to another repository, if a new repositoryId is specified <br> - In this case, all nested skills will be moved to the new repository as well <br> - None of the skills may be used in a learning unit <br> - None of the skills may have an additional parent, which is not moved to the new repository  For the update the following rules apply: - If a value is undefined, it will not be changed - If a value is null, it will be cleared / set to default - If a value is specified, it will be set to the specified value  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.skill_mgmt_controller_update_skill_with_http_info(body, skill_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['body', 'skill_id']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method skill_mgmt_controller_update_skill" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `skill_mgmt_controller_update_skill`")  # noqa: E501
        # verify the required parameter 'skill_id' is set
        if ('skill_id' not in params or
                params['skill_id'] is None):
            raise ValueError("Missing the required parameter `skill_id` when calling `skill_mgmt_controller_update_skill`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/skill-repositories/skill/{skillId}', 'PATCH',
            path_params,
            query_params,
            header_params,
            body=body_params,
