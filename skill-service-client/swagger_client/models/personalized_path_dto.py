...
class PersonalizedPathDto(object):
    ...
    swagger_types = {
        ...
        'goals': 'list[str]',
        'status': 'object',
        'learning_unit_instances': 'list[LearningUnitInstanceStatusDto]'
    }
    ...
    attribute_map = {
        ...
        'goals': 'goals',
        'status': 'status',
        'learning_unit_instances': 'learningUnitInstances'
    }

    def __init__(self, personalized_path_id=None, learning_path_id=None, goals=None, status=None, learning_unit_instances=None):  # noqa: E501
        """PersonalizedPathDto - a model defined in Swagger"""  # noqa: E501
        self._personalized_path_id = None
        self._learning_path_id = None
        self._goals = None
        self._status = None
        self._learning_unit_instances = None
        self.discriminator = None
        self.personalized_path_id = personalized_path_id
        self.learning_path_id = learning_path_id
        self.goals = goals
        self.status = status
        self.learning_unit_instances = learning_unit_instances
    ...
    @property
    def learning_unit_instances(self):
        """Gets the learning_unit_instances of this PersonalizedPathDto.  # noqa: E501

        The sequence of the contained learning unit instances (their unit's id and status)  # noqa: E501

        :return: The learning_unit_instances of this PersonalizedPathDto.  # noqa: E501
        :rtype: list[LearningUnitInstanceStatusDto]
        """
        return self._learning_unit_instances

    @learning_unit_instances.setter
    def learning_unit_instances(self, learning_unit_instances):
        """Sets the learning_unit_instances of this PersonalizedPathDto.

        The sequence of the contained learning unit instances (their unit's id and status)  # noqa: E501

        :param learning_unit_instances: The learning_unit_instances of this PersonalizedPathDto.  # noqa: E501
        :type: list[LearningUnitInstanceStatusDto]
        """
        if learning_unit_instances is None:
            raise ValueError("Invalid value for `learning_unit_instances`, must not be `None`")  # noqa: E501

        self._learning_unit_instances = learning_unit_instances
