...
class LearningProfileDto(object):
    ...
    def semantic_density(self, semantic_density):
        ...
        :type: float
        """
        if semantic_density is None:
            raise ValueError("Invalid value for `semantic_density`, must not be `None`")  # noqa: E501
    ...
    def semantic_gravity(self, semantic_gravity):
        ...
        :type: float
        """
        if semantic_gravity is None:
            raise ValueError("Invalid value for `semantic_gravity`, must not be `None`")  # noqa: E501
    ...
    def processing_time_per_unit(self, processing_time_per_unit):
        ...
        :type: float
        """
        if processing_time_per_unit is None:
            raise ValueError("Invalid value for `processing_time_per_unit`, must not be `None`")  # noqa: E501
    ...
    def preferred_didactic_method(self, preferred_didactic_method):
        ...
        :type: list[str]
        """
        if preferred_didactic_method is None:
            raise ValueError("Invalid value for `preferred_didactic_method`, must not be `None`")  # noqa: E501
