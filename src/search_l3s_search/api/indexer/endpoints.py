...
@ns_indexer.route("/sparse-indexer", endpoint="sparse_indexer")
class SparseIndexer(Resource):
    def post(self):
        return {"message": "Success: Sparse Indexer"}


@ns_indexer.route("/dense-indexer", endpoint="dense_indexer")
class SparseIndexer(Resource):
    def post(self):
        return {"message": "Success: Dense Indexer"}